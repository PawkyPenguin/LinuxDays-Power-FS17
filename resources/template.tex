...
%\let\oldinline\lstinline
%\renewcommand{\lstinline}[1]{\Colorbox{yellow}{\oldinline{#1} }}
\makeatletter
\xpretocmd\lstinline{\Colorbox{tlg}\bgroup\appto\lst@DeInit{\egroup}}{}{}
\makeatother
...
% automatically center image and choose width approximately
...
% insert image with width as percentage of total width
\newcommand{\imgrel}[2]{\begin{figure}[H]%
	\centering
...
\newcommand{\notsobigtext}[1]{\centering\Large \textbf{\textcolor{ldblue}{#1}}}
